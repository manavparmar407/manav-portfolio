          ...
          <div className="text-white space-y-8 animate-fade-in">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <a
                ...
                onClick={() => window.open('https://mail.google.com/mail/?view=cm&fs=1&to=manavparmar0407@gmail.com', '_blank')} target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-2 px-4 py-2.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all hover:scale-105 shadow-lg"
              >
                <Mail className="h-5 w-5 text-white" />
                <span className="text-sm font-medium hidden sm:inline">E-Mail</span>
              </a>
            </div>
          </div>
